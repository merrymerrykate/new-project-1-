 ...
 */
     ...
     */
        ...
        public void setPopulation(int newPopulation){
            if (newPopulation < 0)
                throw new IllegalArgumentException("Население не может быть меньше нуля!");
            else
     ...
     */
        ...
        public void print(){
            System.out.println (name+ ": Площадь страны " +  squer + "; Население страны " + population+ "; Плотность страны " + getPopulationDensity());
            if (capital != null)
                System.out.println("Столица страны " + capital + " Население столицы " + capital_population);
            System.out.println();
